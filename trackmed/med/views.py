...
def createpatient(request):
    ...
    context = {"form": form, "title": "patient data"}
...
def updatepatient(request, id):
    ...
    context = {"form": form, "title": " update patient data"}
...
def viewpatient(request, id):
    patientdata = PatientBio.objects.get(id=id)
    context = {"patientdata": patientdata, "title": " view your data"}
...
def list_health_data(request):
    ...
    context = {"title": "patients health data", "listhealthdata": listhealthdata}
...
def list_medication(request):
    ...
    context = {"title": "list of medication", "listmed": listmed}
...
def create_patient_data(request):
    ...
    context = {"form": form, "title": "create patient medical data"}
...
def list_patient_data(request):
    ...
    context = {"title": "health data", "patientdata": patientdata}
...
def update_patient_data(request, id):
    ...
    context = {"title": "update patient health data", "form": form}
...
def delete_patient_data(request, id):
    ...
    context = {"title": "update patient health data", "patientdata": patientdata}
...
def create_medication(request):
    ...
    context = {"title": "create medication", "form": form}
    return render(request, "med/createmedication.html", context)
